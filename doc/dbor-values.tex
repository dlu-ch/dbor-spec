    ...
    \begin{quote}
        ...
        \begin{tabular}{ll}
            ...
            \DborDecimalRationalValue($-123$, $100$)
                &  \ByteSequence{\DborFirstByte\DborNumberValueColour{D0},
...
\begin{beginparpenalty}
    ...
    \begin{quote}
        ...
        \begin{tabular}{lll}
            ...
            \midrule
            \DborDictionaryValue()
                & \ByteSequence{\DborFirstByte\DborDictionaryValueColour{A0}} \\
            \DborDictionaryValue($\DborIntegerValue(24) \mapsto \DborNoneValue$)
                & \ByteSequence{\DborFirstByte\DborDictionaryValueColour{A3},
                        \DborFirstByte\DborNumberValueColour{18}, \DborNextByte{00},
                        \DborFirstByte\DborNoneValueColour{FF}} \\
            \bottomrule
        \end{tabular}
    ...
    \begin{quote}
        ...
        \begin{tabular}{lll}
            ...
            \DborAllocatorValue(3, \DborIntegerValue(23))
                & \ByteSequence{\DborFirstByte\DborAllocatorValueColour{C0}, \DborNextByte{02},
