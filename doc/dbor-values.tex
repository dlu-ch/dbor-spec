...
\begin{quote}
    ...
    \begin{tabular}{ll}
        ...
        Value & Representation \\
        \midrule
        \DborMinusZeroValue & \ByteSequence{\DborFirstByte\DborNumberValueColour{FC}} \\
        \DborInfinityValue & \ByteSequence{\DborFirstByte\DborNumberValueColour{FE}} \\
        \DborMinusInfinityValue & \ByteSequence{\DborFirstByte\DborNumberValueColour{FD}} \\
        \bottomrule
    \end{tabular}
\end{quote}
