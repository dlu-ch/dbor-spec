...
A \DborNoneValue{} represents the absence of an actual value (like \texttt{null} or \texttt{None} is some
...
An \DborNoneValue{} is the \DborMinimalToken*($3$, $\HexNumber{1F}$).
...
\begin{quote}
    \begin{tabular}{lll}
        ...
        \midrule
        \DborUtfEightStringValue(\ByteSequence{})
            & ""
            &  \ByteSequence{\DborFirstByteString{60}} \\
        \DborUtfEightStringValue(\ByteSequence{\DborNextByte{52}, \DborNextByte{65},
...
\begin{quote}
    \begin{tabular}{lll}
        ...
        \DborDictionaryValue(\DborNoneValue, \DborIntegerValue($24$))
            & \ByteSequence{\DborFirstByteSequence{83},
                    \DborFirstByteNone{FF},
                    \DborFirstByteNumber{18}, \DborNextByte{00}} \\
        \bottomrule
