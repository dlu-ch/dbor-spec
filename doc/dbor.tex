...
\documentclass{dbor-article}
    ...
    \newcommand{\ByteSequence}[1]{\langle #1 \rangle}
    ...
    \newcommand{\DborFirstByte}[2]{\textcolor{#1}{\bm{\HexNumber{#2}}}}
    ...
    \newenvironment{Note}{\smallskip\bgroup\small\ignorespaces}{\par\egroup\smallskip}
